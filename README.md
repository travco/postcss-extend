...
- **Extend Chaining** With or without antipatterns in the code, it will ([per the spec](https://tabatkins.github.io/specs/css-extend-rule/#extend-chaining)) [propagate all inheritance](https://github.com/travco/postcss-extend#chaining-extends-or-extension-recursion) up the chain of rules.
- **Inheritance inside media blocks** As [per the spec](https://tabatkins.github.io/specs/css-extend-rule/#issue-bd856557) (example 3), inheritance [brings in statements](https://github.com/travco/postcss-extend#simple-declaration-pulling) as to be able to use the style statements of it's target rule, with the same contingency of the media block.
